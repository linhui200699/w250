...
//bide add lcm begin
extern LCM_DRIVER st7796s_qvga_dsi_vdo_lcm_drv;
extern LCM_DRIVER st7789v_4line_spi_lcm_drv;
extern LCM_DRIVER nv3029g_4line_spi_lcm_drv;
extern LCM_DRIVER st7789a_4line_spi_lcm_drv;
...
#if defined(ST7789A_4LINE_SPI)
	&st7789a_4line_spi_lcm_drv,
#endif

#if defined(ST7789V_4LINE_SPI)
	&st7789v_4line_spi_lcm_drv,
#endif

#if defined(NV3029G_4LINE_SPI)
	&nv3029g_4line_spi_lcm_drv,
#endif

#if defined(ST7796S_QVGA_DSI_VDO)
	&st7796s_qvga_dsi_vdo_lcm_drv,
#endif
//bide add lcm end
